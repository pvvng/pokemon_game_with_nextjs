...
- ### 5-1. 프로젝트 중 신경 쓴 부분
  ...
  - ##### 비동기 통신
    - 프로젝트의 목표가 비동기 통신의 이해였던 만큼 비동기 통신의 적극적 활용을 지향했습니다. fetch, axios 비동기 통신이 어떻게 동작하고 무엇을 반환하는지 받은 데이터의 가공과 저장 방법과 FE와 BE의 통신 방법과 REST API 를 이해하는 시간이 되었습니다. 특히, 프로젝트 초반 PokeApi에서 데이터를 get하는 과정에서 async와 await의 개념을 제대로 이해하지 못한 것을 알게되었습니다. 해당 내용이 상세하게 궁금하시다면 링크를 눌러 확인해주세요.
    링크~~~~
...
- ### 5-1. 프로젝트 중 어려웠던 부분 && 프로젝트의 아쉬운 부분
  ...
  - ##### 비동기 통신
    ...
    - 가장 오랫동안 고민한 코드인 fetchData 코드를 정리한 blog 링크입니다.
